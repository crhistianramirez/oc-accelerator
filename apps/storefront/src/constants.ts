...
//ContentHub Config
const CH_GRAPHQL_ENDPOINT = import.meta.env.VITE_APP_CH_GRAPHQL_ENDPOINT;
const CH_GRAPHQL_API_KEY = import.meta.env.VITE_APP_CH_GRAPHQL_API_KEY;

// Search Config
const SEARCH_CLIENT_ID = import.meta.env.VITE_APP_SEARCH_CLIENT_ID;
const SEARCH_DOMAIN_ID = import.meta.env.VITE_APP_SEARCH_DOMAIN_ID;
const SEARCH_ENV = import.meta.env.VITE_APP_SEARCH_ENV;
const SEARCH_API_KEY = import.meta.env.VITE_APP_SEARCH_API_KEY;
const SEARCH_ORDERCLOUD_REGION = import.meta.env.VITE_APP_SEARCH_ORDERCLOUD_REGION;
const SEARCH_WIDGET_ID = import.meta.env.VITE_APP_SEARCH_WIDGET_ID;
const SEARCH_PROXY_BASE_URL = import.meta.env.VITE_APP_SEARCH_PROXY_BASE_URL;
